...
class BioreactorMPC:
    def __init__(self, model, scaler_X, scaler_y, input_cols, output_cols, control_settings):
        """
        control_settings: Liste de dicts [{'name': '...', 'min': 0, 'max': 100}, ...]
                          chargée depuis le JSON.
        """
        self.model = model
        ...
        # --- CONSTRUCTION DYNAMIQUE DU CONFIG ---
        self.ctrl_config = []
        ...
        # Création des tenseurs de contraintes min/max normalisés
    ...
    def optimize(self, current_seq_np, horizon=5, steps=10):
        # ... (Le reste de la méthode optimize est identique au code précédent) ...
